  ...
  <div>
    <footer>
      ...
      <div class="dk-bar">
        <div class="container-fluid">
          <div class="row">
            <div class="col-12 col-md-5 mx-auto py-2">
              <ul class="nav justify-content-center">
                <li class="nav-item">
                  <span class="nav-link">© 2020 BRQ</span>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="#"> brq@brq.com </a>
                </li>
                <li class="nav-item">
